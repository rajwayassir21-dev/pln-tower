...
<head>
    ...
    <title>Tambah Data Tower | Admin PLN Tower</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 page-title">Tambah Data Tower</h1>
                            ...
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold">
                                        <i class="fas fa-broadcast-tower mr-2"></i>Form Tambah Data Tower
                                    </h6>
                                    <span class="badge badge-light">Tower Baru</span>
                                </div>
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="{{ route('admin.tower.store') }}" method="POST" id="towerForm" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group-row">
                                                        <label for="description"
                                                            ...
                                                            Tower</label>
                                                        <textarea name="description" id="description" class="form-control-pln @error('description') is-invalid @enderror"
                                                            required placeholder="Masukkan deskripsi lengkap tower">{{ old('description') }}</textarea>
                                                        @error('description')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group-row">
                                                        ...
                                                        <textarea name="lokasi" id="lokasi" class="form-control-pln @error('lokasi') is-invalid @enderror" required
                                                            placeholder="Masukkan alamat lengkap lokasi">{{ old('lokasi') }}</textarea>
                                                        @error('lokasi')
                                                            <div class="invalid-feedback d-block">{{ $message }}
                                                            </div>
                                                        @enderror
                                                    ...
                                                    <div class="form-group-row">
                                                        ...
                                                        <select name="status_sertifikat" id="status_sertifikat"
                                                            ...
                                                            <option value="bersertifikat"
                                                                {{ old('status_sertifikat') == 'bersertifikat' ? 'selected' : '' }}>
                                                                Bersertifikat</option>
                                                            <option value="belum"
                                                                {{ old('status_sertifikat') == 'belum' ? 'selected' : '' }}>
                                                                Belum</option>
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group-row">
                                                        ...
                                                        <input type="number" step="0.01" name="luas"
                                                            ...
                                                            value="{{ old('luas') }}" placeholder="Contoh: 150.50">
                                                        @error('luas')
                                                            <div class="invalid-feedback d-block">{{ $message }}
                                                            </div>
                                                        @enderror
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group-row">
                                                        <label for="no_sertifikat" class="form-label-pln">Nomor
                                                            Sertifikat</label>
                                                        <input type="text" name="no_sertifikat" id="no_sertifikat"
                                                            class="form-control-pln @error('no_sertifikat') is-invalid @enderror"
                                ...
                                <div class="form-actions text-center">
                                    <button type="submit" class="btn btn-simpan">
                                        <i class="fas fa-save mr-2"></i>Simpan Data Tower
                                    </button>
        ...
        $(document).ready(function() {
            ...
            $('#towerForm').submit(function(e) {
                const requiredFields = [
                    ...
                    'latitude', 'longitude', 'kelurahan', 'kecamatan', 'city'
                ];
            ...
            // Set tanggal default untuk tanggal awal (hari ini)
            ...
            $('#status_sertifikat').change(function() {
                ...
                if (status === 'bersertifikat') {
                    $('#no_sertifikat').attr('placeholder', 'Wajib diisi untuk status bersertifikat');
                } else {
                    $('#no_sertifikat').attr('placeholder', 'Nomor sertifikat jika ada');
                }
            });
        });
